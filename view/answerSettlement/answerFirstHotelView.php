        ...
        <div class=".container-fluid" id="cotizacionWrapper" style="width:100%; max-width:1140px; margin:0 auto;">
            ...
            <div class="col-xs-12 seccionBlanca" id="contBookingEngine">
                <form role="form" id="frm_hotel" name="frm_hotel" method="POST" action="<?php echo SUBMIT_APP; ?>">
                    ...
                    <input id="dataLiq" name="dataLiq" class="dataLiq" type="hidden" value="<?php echo htmlspecialchars(urlencode(base64_encode(serialize($liqReservation)))); ?>" />
                    ...
                    <div id="habitacionesUpdateWrapper" class="form-group gruposBooking contDerecho col-xs-12">
                        ...
                        <div id="navHabitacionesHotel">
                            ...
                            <!-- Tab Navigation Menu -->
                            <ul>
                                <li id="hab1Hotel" data-link="hab1" data-habitacion="1"><a><i class="fa fa-bed"></i><span class="tituloTabBooking"><?php echo $this->classExtenstFunction->decodeText($this->classExtenstFunction->capitalizedOmitting($textosCargar["LBL_HABITACION"])); ?> 1</span></a></li>
                                <li id="hab2Hotel" data-link="hab2" data-habitacion="2"><a><i class="fa fa-bed"></i><span class="tituloTabBooking"><?php echo $this->classExtenstFunction->decodeText($this->classExtenstFunction->capitalizedOmitting($textosCargar["LBL_HABITACION"])); ?> 2</span></a></li>
                                <li id="hab3Hotel" data-link="hab3" data-habitacion="3"><a><i class="fa fa-bed"></i><span class="tituloTabBooking"><?php echo $this->classExtenstFunction->decodeText($this->classExtenstFunction->capitalizedOmitting($textosCargar["LBL_HABITACION"])); ?> 3</span></a></li>
                            </ul>
            ...
            <div class="col-xs-12 seccionGris filtroHabitaciones">
                ...
                <ul class="nav nav-pills">
                    ...
                    <li class=""><a class="filtrosClass" data-filtros="2" data-toggle="pill" href="#"><?php echo $this->classExtenstFunction->decodeText($this->classExtenstFunction->capitalizedOmitting($textosCargar["LBL_HABITACION"])); ?></a></li>
